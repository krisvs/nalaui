<template>
    <div class="Sections">
        ...
        <VGroup class="Intro">
            <h1>Sections</h1>
            <div>
                The following sections are available to plug and play into your project.
            </div>
        </VGroup>
    ...
    data() {
        return {
            ...
            content: [
                ...
                {
                    title: 'Manju',
                    subtitle: 'The Sable German Shepherd',
