<template>
    <article>
        ...
        <p>
            nalaui features a minimalistic design system based solely on CSS variables and some lightweight conventions. It is comprised of the following key aspects:
        </p>
        <ul>
        ...
        <p>
            nalaui follows a simple yet efficient approach to manage dual-themed application colors scheme.
        </p>

        <h4>Color tokens</h4>

        <p>nalaui employs layered approach to structure application colors:</p>
        ...
        <p>
            nalaui defines the finite set of semantic tokens:
        </p>
        <ul>
            <li>
